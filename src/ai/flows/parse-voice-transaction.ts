...
export async function parseTranscript(transcript: string): Promise<ParsedTransaction[]> {
...
{
  "transactions": [
    { "type": "expense", "expense": { "vendorName": "...", "totalAmount": 45.00, "category": "Food", "date": "2024-01-15" } },
    { "type": "income", "income": { "sourceName": "Salary", "amount": 3000, "date": "2024-01-15", "note": "..." } }
  ]
}
...
export async function processVoiceTransaction(
    ...
    const transactions = await parseTranscript(transcript);
